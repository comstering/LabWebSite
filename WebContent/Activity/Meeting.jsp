				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<img src="<%= fileDAO.getPath() %>Meeting/<%= fileNames.get(0).substring(fileNames.get(0).lastIndexOf(",") + 1, fileNames.get(0).length()) %>" class="bd-placeholder-img card-img-top" width="100%">
							<div class="card-body">

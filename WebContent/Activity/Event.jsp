				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<img src="/filepath<%= fileDAO.getPath() %>Event/<%= fileNames.get(0).substring(fileNames.get(0).lastIndexOf(",") + 1, fileNames.get(0).length()) %>" class="bd-placeholder-img card-img-top" width="100%" height=210>
							<div class="card-body">
								<p class="card-text abb"><%= list.get(i).getTitle() %></p>
								<div class="d-flex justify-content-between align-items-center">
									<div class="btn-group">
										<a href="view.jsp?category=Event&ID=<%= list.get(i).getID() %>" type="button" class="btn btn-sm btn-outline-secondary">View</a>
									</div>

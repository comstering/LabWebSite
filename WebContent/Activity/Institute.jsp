				...
				<div class="row">
					...
					<%
							...
							for(int i = 0; i < list.size(); i++) {
								ArrayList<String> fileNames = fileDAO.getFile("Institute", list.get(i).getID());
					%>
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<img src="/filepath<%= fileDAO.getPath() %>Institute/<%= fileNames.get(0).substring(fileNames.get(0).lastIndexOf(",") + 1, fileNames.get(0).length()) %>" class="bd-placeholder-img card-img-top" width="100%" height=210>
							<div class="card-body">

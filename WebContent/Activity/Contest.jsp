		...
		<div class="row">
			...
			<main role="main" class="col-md-9 px-4" style="max-width: 72%">
				...
				pt-3 pb-2 mb-3 border-bottom">
					<h1 class="h2">교외공모전</h1>
				</div>
				<div class="row">
					<%
						PostDAO postDAO = new PostDAO();
						FileDAO fileDAO = new FileDAO();
						ArrayList<PostDTO> list = postDAO.getList("Contest", pageNumber);
						if(list.size() == 0) {
					%>
						...
						<div class="card mb-4 shadow-sm">
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									<div class="btn-group">
										<a href="view.jsp?category=Contest&ID=<%= list.get(i).getID() %>" type="button" class="btn btn-sm btn-outline-secondary">View</a>
									</div>
				...
				<%
					if(pageNumber != 1) {
				%>
					<a href="Contest.jsp?pageNumber=<%= pageNumber - 1 %>" class="btn btn-success btn-arraw-left">이전</a>
				<%
					}
					if(postDAO.nextPage("Contest", pageNumber + 1)) {
				%>
					<a href="Contest.jsp?pageNumber=<%= pageNumber + 1 %>" class="btn btn-success btn-arraw-left">다음</a>
				<%
					}
				%>
